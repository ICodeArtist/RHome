...
return  array(
    ...
    /* 数据库设置 */
    'DB_TYPE'               =>  'mysql',     // 数据库类型
    'DB_HOST'               =>  '122.237.102.36', // 服务器地址
    'DB_NAME'               =>  'RHome',          // 数据库名
    'DB_USER'               =>  'root',      // 用户名
    'DB_PWD'                =>  'e1234',          // 密码
    'DB_PORT'               =>  '',        // 端口
    'DB_PREFIX'             =>  'lct_',    // 数据库表前缀
    ...
    'SESSION_OPTIONS'       =>  array('name'=>'admininfo','expire'=>72000), // session 配置数组 支持type name id path expire domain 等参数
